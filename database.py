...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        `.approaches` attribute of each `NearEarthObject` resolves to an
        ...
        for approach in approaches:
            d = approach._designation
            if d in self.neo_designation_dict:
                approach.neo = \
                    self.neo_designation_dict[d]
                self.neo_designation_dict[d].approaches.append(
                    approach)
